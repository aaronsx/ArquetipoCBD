 ...
 */
public class ImplementacionConexionPostgreSQL implements InterfazConexionBD {
	...
	private String[] configuracionConexion() {
		...
		try {
			...
			propiedadesConexion.load(new FileInputStream(new File("src${symbol_escape}${symbol_escape}main${symbol_escape}${symbol_escape}java${symbol_escape}${symbol_escape}Utils${symbol_escape}${symbol_escape}conexion.properties")));
